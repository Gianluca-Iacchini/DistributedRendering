...
enum AVPixelFormat {
     ...
     * mfxHDLPair.second contains the texture1 array index of the frame if the
     * ID3D11Texture2D is an array texture1, or always MFX_INFINITE if it is a
     * normal texture1.
     */
    AV_PIX_FMT_QSV,
    /**
     ...
     * texture1 array index of the frame as intptr_t if the ID3D11Texture2D is
     * an array texture1 (or always 0 if it's a normal texture1).
     */
    AV_PIX_FMT_D3D11,
